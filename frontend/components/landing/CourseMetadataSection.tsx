        ...
        <div id="support" className="mt-20 grid gap-8 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-[#07110f] text-white">
            <div className="grid min-h-full sm:grid-cols-[.72fr_1.28fr]">
              ...
              <div className="p-8 md:p-10"><GraduationCap className="h-7 w-7 text-emerald-300" /><p className="mt-7 font-mono text-xs font-bold uppercase tracking-[.2em] text-emerald-300">Learn from someone building this for real</p><h3 className="mt-4 text-3xl font-semibold tracking-tight">{course.instructor.name}</h3><p className="mt-2 font-semibold text-emerald-200">Senior Tech Lead at Capital One</p><p className="mt-5 text-sm leading-7 text-slate-300">Rico created <a href="https://github.com/capitalone/context-specs" target="_blank" rel="noopener noreferrer" className="font-semibold text-white underline decoration-emerald-300 underline-offset-4">context-specs</a>, Capital One&apos;s first open-source agent harness. This course comes from the work of making coding agents useful inside real engineering systems—not from assembling demos for a content calendar.</p></div>
            </div>
          </div>
        </div>
      </div>
